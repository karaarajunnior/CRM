...
export class DealService {
	static async createDeal(dealData: CreateDealDto) {
	...
	static async updateDeal(id: string, updateData: UpdateDealDto) {
	...
	static async updateDealStage(id: string, stage: string) {
		const deal = await prisma.deal.update({
			where: { id },
			data: {
				stage,
