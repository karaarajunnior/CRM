...
import { ContactInfo, CustomField, DocumentAttachment } from "../types/types";
...
export class CustomerService {
	static async createCustomer(customerData: any) {
		...
		return await prisma.customer.create({
			data: {
				...
				// Handle tags via connectOrCreate
				customerTags: tags
					? {
	...
	static async addContactMethod(customerId: string, contactData: ContactInfo) {
